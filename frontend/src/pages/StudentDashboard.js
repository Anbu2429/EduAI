...
function StudentDashboard({ username = "gokul" }) {
  ...
  return (
    // boxSizing + overflowX hidden prevents MUI's negative-margin grid
    // tricks (or any stray horizontal scroll) from ever showing up as
    // "extra whitespace" at the right edge of the page.
    <Box
      sx={{
        background: "#f4f6fb",
        minHeight: "100vh",
    ...
    >
      ...
      >
        ...
        {/* Avatar pinned to the far right edge of the hero */}
        <Avatar
          sx={{
            width: 96,
            height: 96,
      ...
      {/* ---------------- TOP CARDS (2 per row, full width, no gap overflow) ---------------- */}
      ...
      >
        ...
        <Card sx={{ borderRadius: 4 }}>
          <CardContent sx={{ p: 3 }}>
            <Stack direction="row" spacing={3} alignItems="center">
              <Avatar
                sx={{ width: 80, height: 80, bgcolor: "#edf2ff", color: "#2458ff" }}
              >
        ...
        <Card sx={{ borderRadius: 4 }}>
          <CardContent sx={{ p: 3 }}>
            <Stack direction="row" spacing={3} alignItems="center">
              <Avatar
                sx={{ width: 80, height: 80, bgcolor: "#e9f9ef", color: "#17a34a" }}
              >
      ...
      {/* ---------------- AI ANALYSIS + RESUME (2 per row, full width) ---------------- */}
            ...
            >
              <Box>
                <Stack direction="row" spacing={2} alignItems="center">
                  <Avatar
                    sx={{ bgcolor: "#edf2ff", width: 60, height: 60, color: "#2458ff" }}
                  >
                    <SmartToy />
                  </Avatar>
                ...
                <Typography
                  sx={{ mt: 3, color: "text.secondary", lineHeight: 1.8, fontSize: 17 }}
                >
                  Analyze your profile and discover your placement readiness
                  score.
                </Typography>
            ...
            >
              <Box>
                ...
                <Typography
                  sx={{ mt: 3, color: "text.secondary", lineHeight: 1.8, fontSize: 17 }}
                >
                  Upload your resume (PDF only) and get AI-powered
                  suggestions.
                </Typography>
      ...
      {/* ---------------- BOTTOM SECTION (4 per row, full width, no trailing gap) ---------------- */}
      ...
      >
        ...
        <Card sx={{ borderRadius: 4, height: "100%" }}>
          <CardContent>
            <Stack direction="row" spacing={2} alignItems="center" mb={3}>
              <Avatar sx={{ bgcolor: "#efe7ff", color: "#7c4dff" }}>
                <Assignment />
              </Avatar>
            ...
            <List disablePadding>
              ...
              <ListItem disableGutters>
                <ListItemText primary="Aptitude Set 3" secondary="25 Questions • Not Started" />
        ...
        <Card sx={{ borderRadius: 4, height: "100%" }}>
          <CardContent>
            <Stack direction="row" spacing={2} alignItems="center" mb={3}>
              <Avatar sx={{ bgcolor: "#edf2ff", color: "#2458ff" }}>
                <School />
              </Avatar>
            ...
            <Stack spacing={3}>
              ...
              <Box>
                <Typography fontWeight="600">🟢 React Quiz</Typography>
                <Typography color="text.secondary" variant="body2">
                  25 July
                </Typography>
              </Box>
        ...
        <Card sx={{ borderRadius: 4, height: "100%" }}>
          <CardContent sx={{ p: 3.5 }}>
            ...
            >
              ...
              >
                {Math.round(
                  [90, 75, 82, 70, 60].reduce((a, b) => a + b, 0) / 5
                )}
                % avg
              </Typography>
            </Stack>
            ...
            <Stack spacing={2.75}>
              {[
                ...
                const level =
                  score >= 85
                    ? { label: "Advanced", color: "#17a34a", bg: "#e9f9ef" }
                    : score >= 70
                    ? { label: "Proficient", color: "#2458ff", bg: "#edf2ff" }
                ...
                return (
                  <Stack key={skill} spacing={1.1}>
                    ...
                    >
                      ...
                      <Typography fontWeight="bold" sx={{ color: level.color }}>
                        {score}%
                      </Typography>
                    </Stack>
        ...
        <Card sx={{ borderRadius: 4, height: "100%" }}>
          <CardContent>
            <Stack direction="row" spacing={2} alignItems="center" mb={3}>
              <Avatar sx={{ bgcolor: "#fff3e0", color: "#fb8c00" }}>
                <Notifications />
              </Avatar>
            ...
            <List disablePadding>
              ...
              <ListItem disableGutters>
                <ListItemText primary="Coding Challenge" secondary="Complete today's DSA challenge." />
              </ListItem>

              <Divider />

              <ListItem disableGutters>
                <ListItemText primary="Mock Interview" secondary="Scheduled on 28 July." />
              </ListItem>
            </List>
          </CardContent>
        </Card>
